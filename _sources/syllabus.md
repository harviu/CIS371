...
| 6, 02/16 | [Quiz 4](quizzes/4.md) | [🎬](https://youtu.be/PRdva1HdekQ),[TypeScript 5](assets/pdf/TypeScript-V.pdf) | [TypeScript 6](assets/pdf/TypeScript-VI.pdf) | {ref}`resources <content:references:w6>` |
| 7, 02/23 | HTTP \| JavaScript Modules | Vue.js 1 | Vue.js 2 \| A2 | {ref}`resources <content:references:w5>` |
